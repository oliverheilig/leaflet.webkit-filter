...
L.PtvLayer = L.NonTiledLayer.extend({
    ...
    _addInteraction: function (resp) {
        ...
        for (var i = 0; i < objects.length; i++) {
            ...
            var latlng = this._map.containerPointToLatLng([objects[i].pixel.x, objects[i].pixel.y]);
...
L.PtvLayer.DataManager = L.PtvLayer.extend({
    ...
    // Method updating the layer id. Saves the new layer id and redraws the layer with the new content.
    // layerId: String -> Id of the new layer to be displayed.
    updateLayerId: function(layerId) { //String
        this.layerId = layerId;
        this.redraw();
    },
